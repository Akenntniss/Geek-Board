...
(function() {
    ...
    function initDockEffects() {
        console.log("[dock-effects] Initialisation...");
        
        // Sélectionner la barre de navigation
        const mobileDock = document.getElementById('mobile-dock');
        if (!mobileDock) {
            console.log("[dock-effects] Élément mobile-dock non trouvé, nouvelle tentative dans 1 seconde");
        ...
        if (mobileDock.hasAttribute('data-dock-effects-initialized')) {
            console.log("[dock-effects] Déjà initialisé");
            return;
        }
        ...
        console.log("[dock-effects] Auto-hide activé (délai: " + (autoShowDelay/1000) + "s)");
        ...
        function hideDock() {
            ...
            console.log("[dock-effects] Dock masqué");
        }
        ...
        function showDock() {
            ...
            console.log("[dock-effects] Dock visible");
        }
        ...
        const handleScroll = function(e) {
            ...
            if (!document.getElementById('mobile-dock')) {
                console.log("[dock-effects] Le dock a été retiré du DOM, réinitialisation");
            ...
            scrollTimer = setTimeout(function() {
                showDock();
                console.log("[dock-effects] Dock réaffiché automatiquement après " + (autoShowDelay/1000) + " secondes");
            }, autoShowDelay);
        };
        ...
        const observer = new MutationObserver(function(mutations) {
            ...
            if (dock && dock.hasAttribute('data-dock-state')) {
                ...
                if (state === 'hidden' && (!dock.classList.contains('hidden') && !dock.classList.contains('dock-hidden'))) {
                    ...
                    console.log("[dock-effects] Conflit détecté: réapplication de l'état caché");
                    hideDock();
                    ...
                    console.log("[dock-effects] Conflit détecté: réapplication de l'état visible");
                    showDock();
                }
            }
        });
        ...
        console.log("[dock-effects] Initialisation terminée");
    }
